...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField]
    [Range(2f, 500)]
    private float playerHorizontalSpeed = 200;
    ...
    private void MovePlayer()
    {
        ...
        Vector3 Vec3NewRotate = new Vector3(0f, 0f, -PlayerMovementDirection().x);
    ...
    {   
        var baseDirection = playerTransform.right * UIInputSystem.ME.GetAxisHorizontal(JoyStickAction.Movement) + playerTransform.forward * UIInputSystem.ME.GetAxisVertical(JoyStickAction.Movement);
