...
public class EnemySpawner : Singleton<EnemySpawner>
{
    ...
    public void onClickStart()
    {
        ...
        enemyTimeSpawn = resourceTimeSpawn = Time.realtimeSinceStartup;
    }
    ...
    public void UpdateScreenSize(float scaleValue)
    {
        ...
        if (main != null)
        {
            ...
            LeanTween.value(GetComponent<Camera>().gameObject, GetComponent<Camera>().orthographicSize, 0.5f, 1.7f).setOnUpdate((float flt) =>   {
                GetComponent<Camera>().orthographicSize = flt;
            });
